    ...
    <div className="main">
      <div className="mainDiv">
        ...
        <p>
          ...
          Note: You'll have one challenge when you will be asked to make this
          page better.
        </p>
        <ul>
          <li>
            <a
              href="http://reactjs.org/docs/getting-started.html"
              target="_blank"
            >
              The Official Docs
            </a>
          ...
          <li>
            <a href="https://www.udemy.com/course/react-redux/" target="_blank">
              Stephen Grinder's Udemy Course for the Udemy API
            </a>
          </li>
          <li>
            <a
              href="https://www.pluralsight.com/courses/react-js-getting-started"
              target="_blank"
            >
          ...
          <li>
            <a
              ...
              target="_blank"
            >
              Maximilian Schwarzmüller's Udemy Course
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="https://github.com/bmorelli25/interactive-bitcoin-pricechart"
              target="_blank">
              Bitcoin
            </a>
          </li>
